...
import {Mail, Lock, User, ArrowLeft, CheckCircle, Loader2, Moon, Sun} from "lucide-react";
				...
				<AnimatePresence mode='wait'>
					...
					{phase === "form" && (
						...
						>
							<div className='w-full'>
								<h1 className='text-2xl sm:text-3xl font-bold text-center mb-2'>Đăng ký</h1>
					...
					{phase === "success" && (
						...
						>
							...
							<h1 className='text-3xl font-bold mb-2'>Đăng ký thành công!</h1>
