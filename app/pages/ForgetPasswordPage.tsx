...
import {Mail, ArrowLeft, CheckCircle, Lock, Loader2, Moon, Sun} from "lucide-react";
	...
	return (
		<div className='min-h-screen bg-white dark:bg-black text-black dark:text-white flex flex-col transition-colors duration-300'>
			<header className='flex items-center justify-between px-4 sm:px-10 py-4 sm:py-6'>
				{phase === "email" ? (
					<Link href='/sign-in' className='flex items-center gap-3 hover:opacity-80 transition-opacity'>
				...
				<AnimatePresence mode='wait'>
					...
					{phase === "pin" && (
						...
						>
							<div className='w-full text-center'>
								...
								<h1 className='text-2xl sm:text-3xl font-bold mb-2'>Xác thực email</h1>
								<p className='text-sm sm:text-base text-black/50 dark:text-white/50 mb-2'>
									Chúng tôi đã gửi mã PIN 6 số đến
								</p>
								<p className='font-medium mb-6 sm:mb-8 text-sm sm:text-base truncate'>{email}</p>
								...
								<form onSubmit={handlePinSubmit}>
									<div className='flex justify-center gap-1.5 sm:gap-2 mb-6' onPaste={handlePinPaste}>
										{pin.map((digit, index) => (
											<input
												key={index}
					...
					{phase === "password" && (
						...
						>
							<div className='w-full'>
								...
								<h1 className='text-2xl sm:text-3xl font-bold text-center mb-2'>Đặt mật khẩu mới</h1>
								<p className='text-sm sm:text-base text-black/50 dark:text-white/50 text-center mb-6 sm:mb-8'>
					...
					{phase === "success" && (
						...
						>
							...
							<h1 className='text-3xl font-bold mb-2'>Đổi mật khẩu thành công!</h1>
