	...
	return (
		<div className={`space-y-2 ${containerClassName || ""}`}>
			...
			<div className='relative group'>
				{Icon && (
					<div className='absolute left-3 top-0 bottom-0 flex items-center justify-center pointer-events-none text-black/40 dark:text-white/40 group-focus-within:text-[#ff79c6] transition-colors'>
				...
				<input
					...
					} text-black dark:text-white placeholder-black/30 dark:placeholder-white/30 focus:outline-none focus:border-[#ff79c6]/50 focus:ring-1 focus:ring-[#ff79c6]/50 transition-all ${
						className || ""
					}`}
					{...props}
				/>
